...
AKillShotCamerasCharacter::AKillShotCamerasCharacter()
{
...
void AKillShotCamerasCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AKillShotCamerasCharacter::TouchStarted);
	if (EnableTouchscreenMovement(PlayerInputComponent) == false)
	{
		PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AKillShotCamerasCharacter::OnFire);
	}

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AKillShotCamerasCharacter::OnResetVR);

	PlayerInputComponent->BindAxis("MoveForward", this, &AKillShotCamerasCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AKillShotCamerasCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &AKillShotCamerasCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AKillShotCamerasCharacter::LookUpAtRate);
}

void AKillShotCamerasCharacter::OnFire()
{
...
void AKillShotCamerasCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AKillShotCamerasCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AKillShotCamerasCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AKillShotCamerasCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
void AKillShotCamerasCharacter::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AKillShotCamerasCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AKillShotCamerasCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AKillShotCamerasCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

bool AKillShotCamerasCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	bool bResult = false;
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		bResult = true;
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AKillShotCamerasCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AKillShotCamerasCharacter::EndTouch);
