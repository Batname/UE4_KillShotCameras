...
KillShotCamerasRootPath=/media/bat/SecondSSD/Projects/Unreal/KillShotCameras

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/KillShotCameras/KillShotCameras.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(KillShotCamerasSource.pri)
include(KillShotCamerasHeader.pri)
include(KillShotCamerasConfig.pri)
include(KillShotCamerasIncludes.pri)
include(KillShotCamerasDefines.pri)
...
KillShotCameras-Linux-Debug.commands = $$build KillShotCameras Linux Debug  -project="\"$$gameProjectFile\"" $$args
KillShotCameras-Linux-DebugGame.commands = $$build KillShotCameras Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
KillShotCameras-Linux-Shipping.commands = $$build KillShotCameras Linux Shipping  -project="\"$$gameProjectFile\"" $$args
KillShotCameras-Linux-Test.commands = $$build KillShotCameras Linux Test  -project="\"$$gameProjectFile\"" $$args
KillShotCameras.commands = $$build KillShotCameras Linux Development  -project="\"$$gameProjectFile\"" $$args

KillShotCamerasEditor-Linux-Debug.commands = $$build KillShotCamerasEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
KillShotCamerasEditor-Linux-DebugGame.commands = $$build KillShotCamerasEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
KillShotCamerasEditor-Linux-Shipping.commands = $$build KillShotCamerasEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
KillShotCamerasEditor-Linux-Test.commands = $$build KillShotCamerasEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
KillShotCamerasEditor.commands = $$build KillShotCamerasEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	KillShotCameras-Linux-Debug \
	KillShotCameras-Linux-DebugGame \
	KillShotCameras-Linux-Shipping \
	KillShotCameras-Linux-Test \
	KillShotCameras \
	KillShotCamerasEditor-Linux-Debug \
	KillShotCamerasEditor-Linux-DebugGame \
	KillShotCamerasEditor-Linux-Shipping \
	KillShotCamerasEditor-Linux-Test \
	KillShotCamerasEditor \
