...
KillShotCameras-Linux-Debug:
	 $(PROJECTBUILD) KillShotCameras Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCameras-Linux-DebugGame:
	 $(PROJECTBUILD) KillShotCameras Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCameras-Linux-Shipping:
	 $(PROJECTBUILD) KillShotCameras Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCameras-Linux-Test:
	 $(PROJECTBUILD) KillShotCameras Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCameras:
	 $(PROJECTBUILD) KillShotCameras Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCamerasEditor-Linux-Debug:
	 $(PROJECTBUILD) KillShotCamerasEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCamerasEditor-Linux-DebugGame:
	 $(PROJECTBUILD) KillShotCamerasEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCamerasEditor-Linux-Shipping:
	 $(PROJECTBUILD) KillShotCamerasEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCamerasEditor-Linux-Test:
	 $(PROJECTBUILD) KillShotCamerasEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

KillShotCamerasEditor:
	 $(PROJECTBUILD) KillShotCamerasEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
